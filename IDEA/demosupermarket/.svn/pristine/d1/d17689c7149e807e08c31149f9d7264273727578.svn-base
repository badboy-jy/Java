...
<div class="main">
    ...
    <form id="form" name="form" method="post" action="/bill">
        <input name="method" value="addbill" type="hidden">
        <div class="content">
            <table class="box">
                <tbody>
                <tr>
                    <td class="field">商品名称：</td>
                    <td><input id="goodsName" name="goodsName" class="text" type="text"> <font color="red"></font></td>

                </tr>
                <tr>
                    <td class="field">商品数量：</td>
                    <td><input id="goodsCount" name="goodsCount" cols="45" rows="5"></input><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">交易金额：</td>
                    <td><input name="money" id="money" class="text" type="text"><font color="red"></font></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="supplier_id" id="supplier_id" class="text" type="text"><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">商品描述：</td>
                    <td><textarea name="goodsDescription" id="goodsDescription" class="text" type="text"></textarea><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">账单时间：</td>
                    <td><input name="time" id="time" class="text" type="Date"><font color="red"></font></td>
                </tr>
                </tbody></table>
        </div>
