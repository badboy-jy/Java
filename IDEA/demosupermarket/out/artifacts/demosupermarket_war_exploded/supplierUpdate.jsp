        ...
        <div class="content">
            <table class="box">
                ...
                <tr>
                    ...
                    <td><input id="supplierName" name="supplierName" class="text" type="text" value="${supplier.supplierName}"> <font color="red"></font></td>

                </tr>
                <tr>
                    <td class="field">供应商描述：</td>
                    <td><textarea id="supplierDesc" name="supplierDesc" cols="45" rows="5"> ${supplier.supplierDesc}</textarea><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">供应商联系：</td>

                    <td><input name="supplierPerName" id="supplierPerName" class="text" type="text"  value="${supplier.supplierPerName}"><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">供应商电话：</td>
                    <td><input name="supplierPhone" id="supplierPhone" class="text" type="text"  value="${supplier.supplierPhone}"><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">供应商传真：</td>

                    <td><input name="supplierChuanZhen" id="supplierChuanZhen" class="text" type="text"  value="${supplier.supplierChuanZhen}"><font color="red"></font></td>
                </tr>
                <tr>
                    <td class="field">供应商地址：</td>
                    <td><input name="supplierAddress" id="supplierAddress" class="text" type="text"  value="${supplier.supplierAddress}"><font color="red"></font></td>
                </tr>
                </tbody></table>
        </div>
