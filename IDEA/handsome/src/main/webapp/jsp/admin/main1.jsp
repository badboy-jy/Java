...
<div class="container clearfix">
     <div class="sidebar-wrap">
       ...
       <div class="p">              <ul class="sub-menu">
                        <li><a href="/wronglist"><i class="icon-font">&#xe017;</i>待处理报障</a></li>
                       	<li><a href="/selectallwrong"><i class="icon-font">&#xe017;</i>已处理报障</a></li>
    ...
    <div class="main-wrap">
       ...
       <jsp:include page="${mainPage==null?'/jsp/admin/index.jsp':mainPage}"></jsp:include>
            </div>
        </div>
